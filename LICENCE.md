KoboshFolia inherits its licensing from the included upstream projects.

As such, KoboshFolia is licensed under the
[GNU General Public License version 3](licenses/GPL.md); as it inherits it from Folia, as it inherits it from Paper, as it inherits it from Spigot,
...
```text
koboshchan <kobosh@kobosh.com> <lucaszhang1001@gmail.com>
```
